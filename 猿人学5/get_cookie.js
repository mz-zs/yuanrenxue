...
// console.log(global.btoa("解决window.btoa没有定义的问题"))
    ...
    while (i <= 4) {
        ...
        function _0x12b47d(_0x149183) {
            var _0xabbcb3, _0x1145c3 = '', _0x4fce58 = 128;
            var temp_array = []
            for (_0xabbcb3 = 0x0; _0xabbcb3 < _0x4fce58; _0xabbcb3 += 0x8)
                _0x1145c3 += String['fromCharCode'](_0x149183[_0xabbcb3 >> 0x5] >>> _0xabbcb3 % 0x20 & 0xff),
                    temp_array.push((_0x149183[_0xabbcb3 >> 0x5] >>> _0xabbcb3 % 0x20 & 0xff))
            return _0x1145c3;
        }
        ...
        function _0x11a7a2(_0x193f00, _0x1cfe89) {
            ...
            var _0x1badc3, _0x38ca59, _0x431764, _0x43f1b4, _0x5722c0, _0x3e0c38 = 0x67452301, _0xdb4d2c = _0x4dae05,
        ...
        function _0x1ee7ec(_0x206333) {
            return _0x12b47d(_0x11a7a2(_0x35f5f2(_0x206333), 104));
        }


        function _0x41873d(_0x5a6962) {
            return _0x1ee7ec((_0x5a6962)['toString']());
        }
        ...
        function _0x37614a(d) {
            return _0x499969(_0x41873d(d));
        }

        function _0x474032(a, b, c) {
            return _0x37614a(a);
        }

        var _$Wa = _0x12eaf3();
        _0x4e96b4['_$pr']['push'](_0x474032(_$Wa))
        var m = _0x474032(_$Wa)
        ...
        if (i === 5) {
            ...
            var _$yw = _0x2d5f5b()['toString']()

            _0x4e96b4['_$pr']['push'](_0x474032(_$yw))
            var m = _0x474032(_$yw)
        }
    }

    _$Ww = _$Tk['enc']['Utf8']['parse'](_0x4e96b4['_$pr']['toString']())
    _0x4e96b4['_$yw'] = _0x2d5f5b()['toString']()
    _0x4e96b4['_$is'] = _0x4e96b4['_$yw']


    _0x4e96b4['_$qF'] = _$Tk['enc']['Utf8']['parse'](self['btoa'](_0x4e96b4['_$is'])['slice'](0x0, 0x10));
    var _0x29dd83 = _$Tk['AES']['encrypt'](_$Ww, _0x4e96b4['_$qF'], {
        'mode': _$Tk['mode']['ECB'],
        'padding': _$Tk['pad']['Pkcs7']
    })
    _0x4e96b4['_$ss'] = _0x29dd83['toString']()
    var cookie_param = _0x4e96b4['_$ss']
    return {
        'RM4hZBv0dDon443M': cookie_param,
        'm': m,
        '_$is': _$yw,
        '_$t1': Date.parse(new Date())
    }
